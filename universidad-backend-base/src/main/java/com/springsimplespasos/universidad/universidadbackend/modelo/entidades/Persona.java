...
)*///annotation to tell Jackson to use the 'name' property to determine the type of the object
//these annotations are used when there is inheritance implemented in the entity
